...
export interface RaffleInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "enterTheRaffle",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getLastBlockStamp",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getNumberOfConfirmations",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getRecenWinner",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "RequstedRaffleWinner(uint256)": EventFragment;
    "WinnerPicked(address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "RaffleEnter"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RequstedRaffleWinner"): EventFragment;
...
export interface RequstedRaffleWinnerEventObject {
  requestId: BigNumber;
}
export type RequstedRaffleWinnerEvent = TypedEvent<
  [BigNumber],
  RequstedRaffleWinnerEventObject
>;

export type RequstedRaffleWinnerEventFilter =
  TypedEventFilter<RequstedRaffleWinnerEvent>;
...
export interface Raffle extends BaseContract {
  ...
  functions: {
    ...
    getLastBlockStamp(overrides?: CallOverrides): Promise<[BigNumber]>;

    getNumWords(overrides?: CallOverrides): Promise<[BigNumber]>;

    getNumberOfConfirmations(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    getRecenWinner(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    enterTheRaffle(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "RequstedRaffleWinner(uint256)"(
      requestId?: PromiseOrValue<BigNumberish> | null
    ): RequstedRaffleWinnerEventFilter;
    RequstedRaffleWinner(
      requestId?: PromiseOrValue<BigNumberish> | null
    ): RequstedRaffleWinnerEventFilter;
  ...
  estimateGas: {
    ...
    getRecenWinner(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getLastBlockStamp(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    getRecenWinner(overrides?: CallOverrides): Promise<PopulatedTransaction>;
